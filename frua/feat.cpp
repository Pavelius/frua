...
{"UseLeatherArmor", "Использует кожанные доспехи", 1},
{"UseMetalArmor", "Использует металические доспехи", 1},
{"UseShield", "Использует щит", 1},
{"UseTheifWeapon", "Использует оружие воров", 1},
{"UseMartialWeapon", "Использует ратное оружие", 1},
{"UseLargeWeapon", "Использует большое оружие", 1},
