...
static wear_info wear_data[] = {{"Head", "Голова", "Головные уборы", {Head, Backpack}, 0, 1},
{"Neck", "Шея", "Амулеты", {Neck, Backpack}, 0, 1},
{"Armor", "Броня", "Доспехи", {Armor, Backpack}, 0, 1},
...
{"GridleWear", "Пояс", "Пояса", {GridleWear, Backpack}, 0, 1},
{"LeftRing", "Кольцо на левом пальце", 0, {LeftRing, RightRing}, 0, 1},
{"RightRing", "Кольцо на пальце", "Кольца", {LeftRing, RightRing}, 0, 1},
