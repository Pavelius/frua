...
{}};
static markup item_general_с2[] = {{0, "Оружие", {0, 0, weapon_block}, 0, {0, hasdamage}},
{0, "Броня", {0, 0, armor_block}, 0, {0, hasarmor}},
{0, "Бонус к характеристикам", {0, 0, ability_block}, 0, {0, hasability}},
{}};
...
static markup saving_throws_block[] = {{0, "#skill", {"skills"}, 3, {is_save_thrown}}, {}};
static markup theif_skills_block[] = {{0, "#skill", {"skills"}, 3, {is_theif_skill}}, {}};
static markup other_skills_block[] = {{0, "#skill", {"skills"}, 3, {is_other_skill}}, {}};
